...
void sfx_AmbientLv3() {
	PtcSystem* ptc = ptc_CreateSystem(-1.f, 2.f, 1, 0.f, 5000.f, 215.f, 235.f, PTC_GRAV_NONE, NULL);
	ptc_SetType(ptc, PTC_SHARD, 0.f, 4.f, 5, 5, Color(192, 128, 255), Color(128, 255, 224));
	ptc_SetShape(ptc, PTCS_RECTANGLE, Vector2f(game_GetScrollX(), -100.f), Vector2f(game_GetScrollX() + 3200.f, -10.f));
}

void sfx_PlayerPropeller() {
	PtcSystem* propellerPtc = ptc_CreateSystem(-1.f, .25f, 1, 50.f, 250.f, -100.f, -80.f, PTC_GRAV_NONE, NULL);
...
void sfx_PlayerFire() {
	PtcSystem* firePtc = ptc_CreateSystem(-1.f, .333f, 5, 60.f, 120.f, plr_Player.rot - 20.f, plr_Player.rot + 20.f, PTC_GRAV_NONE, NULL);
...
void sfx_PlayerHit() {
	PtcSystem* firePtc = ptc_CreateSystem(-1.f, 3.f, 250, 0.f, 1000.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
...
void sfx_ProjectileImpact(sfVector2f _pos, sfVector2f _spd, sfColor _clr) {
	PtcSystem* ptc = ptc_CreateSystem(-1.f, .5f, 10, 200.f, 1000.f, 60.f - v_AngAbsD(_spd), 120.f - v_AngAbsD(_spd), PTC_GRAV_NONE, NULL);
...
void sfx_EnemyFire(sfVector2f _pos, sfVector2f _dir, sfColor _clr) {
	PtcSystem* firePtc = ptc_CreateSystem(-1.f, .5f, 5, 250.f, 1000.f, v_AngAbsD(_dir) + 70.f, v_AngAbsD(_dir) + 110.f, PTC_GRAV_NONE, NULL);
...
void sfx_EnemyGlimmerTrail(sfVector2f _pos, sfColor _clr) {
	PtcSystem* ptc1 = ptc_CreateSystem(-1.f, 2.f, 1, 0.f, 100.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
...
void sfx_EnemyGlimmerWaves(sfVector2f _pos, sfColor _clr, sfBool _linger) {
	...
	PtcSystem* ptc1 = ptc_CreateSystem(-1.f, 2.5f * lt, 50, 125.f, 125.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
	ptc_SetType(ptc1, PTC_SHARD, 1.f, 5.f, 3, 3, sfWhite, _clr);
	ptc_SetShape(ptc1, PTCS_POINT, _pos);

	PtcSystem* ptc2 = ptc_CreateSystem(-1.f, 1.75f * lt, 50, 250.f, 250.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
	ptc_SetType(ptc2, PTC_SHARD, 2.f, 6.f, 3, 3, sfWhite, _clr);
	ptc_SetShape(ptc2, PTCS_POINT, _pos);

	PtcSystem* ptc3 = ptc_CreateSystem(-1.f, 1.f * lt, 50, 375.f, 375.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
...
void sfx_EnemyFlareTrail(sfVector2f _pos, sfColor _clr) {
	PtcSystem* ptc1 = ptc_CreateSystem(-1.f, 2.f, 1, 0.f, 400.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
	ptc_SetType(ptc1, PTC_SHARD, 1.f, 5.f, 3, 3, ColorA(255, 255, 255, _clr.a), _clr);
	ptc_SetShape(ptc1, PTCS_CIRCLE, _pos, 90.f);
}

void sfx_EnemyFlareWaves(sfVector2f _pos, sfColor _clr) {
	PtcSystem* ptc1 = ptc_CreateSystem(-1.f, 2.5f, 50, 375.f, 375.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
	ptc_SetType(ptc1, PTC_SHARD, 1.f, 5.f, 3, 3, sfWhite, _clr);
	ptc_SetShape(ptc1, PTCS_POINT, _pos);

	PtcSystem* ptc2 = ptc_CreateSystem(-1.f, 1.75f, 50, 625.f, 625.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
	ptc_SetType(ptc2, PTC_SHARD, 2.f, 6.f, 3, 3, sfWhite, _clr);
	ptc_SetShape(ptc2, PTCS_POINT, _pos);

	PtcSystem* ptc3 = ptc_CreateSystem(-1.f, 1.f, 50, 875.f, 875.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
	ptc_SetType(ptc3, PTC_SHARD, 3.f, 8.f, 3, 3, sfWhite, _clr);
	ptc_SetShape(ptc3, PTCS_POINT, _pos);
}

void sfx_EnemyIncandesceShatter(sfVector2f _pos, sfColor _clr1, sfColor _clr2) {
	PtcSystem* ptc1 = ptc_CreateSystem(-1.f, 2.f, 50, 500.f, 1500.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
	ptc_SetType(ptc1, PTC_SHARD, 10.f, 20.f, 3, 5, _clr1, _clr2);
	ptc_SetShape(ptc1, PTCS_POINT, _pos);
}

void sfx_EnemyShockwaveWaves(sfVector2f _pos, sfColor _clr) {
	PtcSystem* ptc1 = ptc_CreateSystem(-1.f, 2.5f, 100, 375.f, 375.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
	ptc_SetType(ptc1, PTC_SHARD, 1.f, 5.f, 3, 3, sfWhite, _clr);
	ptc_SetShape(ptc1, PTCS_POINT, _pos);

	PtcSystem* ptc2 = ptc_CreateSystem(-1.f, 1.75f, 100, 625.f, 625.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
	ptc_SetType(ptc2, PTC_SHARD, 2.f, 6.f, 3, 3, sfWhite, _clr);
	ptc_SetShape(ptc2, PTCS_POINT, _pos);

	PtcSystem* ptc3 = ptc_CreateSystem(-1.f, 1.f, 100, 875.f, 875.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
	ptc_SetType(ptc3, PTC_SHARD, 3.f, 8.f, 3, 3, sfWhite, _clr);
	ptc_SetShape(ptc3, PTCS_POINT, _pos);
}

void sfx_EnemyDeath(sfVector2f _pos, sfColor _clr) {
	PtcSystem* ptc = ptc_CreateSystem(-1.f, 1.f, 75, 125.f, 500.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
...
void sfx_EnemyBossDeath(sfVector2f _pos, sfColor _clr) {
	PtcSystem* ptc = ptc_CreateSystem(-1.f, 5.f, 500, 125.f, 1000.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
	ptc_SetType(ptc, PTC_SHARD, 1.f, 6.f, 3, 3, sfWhite, _clr);
	ptc_SetShape(ptc, PTCS_CIRCLE, _pos, 20.f);
}
...
PtcSystem* sfx_PowerupParticle(sfVector2f _pos, enum PwrType _type) {
	...
	PtcSystem* ptc = ptc_CreateSystem(100000.f, 2.f, 25, 50.f, 250.f, 0.f, 360.f, PTC_GRAV_NONE, NULL);
